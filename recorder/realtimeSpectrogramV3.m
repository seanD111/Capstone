...
axis('xy');
myGUIdata.titleText = title('Narrowband spectrogram','fontunit','normalized','fontsize',0.035);
xlabel('time (s)');
ylabel('frequency (Hz)')
...
switch get(hObject,'Value')
    case 1
        ...
        set(myGUIdata.titleText,'string','Narrowband spectrogram','fontunit','normalized','fontsize',0.035);
    ...
    case 2
        ...
        set(myGUIdata.sgramAxis,'xlim',[myGUIdata.timeAxis(1) myGUIdata.timeAxis(end)]-myGUIdata.timeAxis(end), ...
            'ylim',[myGUIdata.visibleFrequencyAxis(1) myGUIdata.visibleFrequencyAxis(end)]);
        set(myGUIdata.titleText,'string','Wideband spectrogram','fontunit','normalized','fontsize',0.035);
    ...
    case {3,4,5}
        ...
        switch get(hObject,'Value')
            case 5
                set(myGUIdata.titleText,'string','Simulated 1/3 octave band filter, based on 80 ms Nuttallwin','fontunit','normalized','fontsize',0.035);
            case 3
                set(myGUIdata.titleText,'string','Simulated ERB_N filter, based on 80 ms Nuttallwin (temporal resolution is misleading!)','fontunit','normalized','fontsize',0.035);
            case 4
                set(myGUIdata.titleText,'string','Simulated Bark filter, based on 80 ms Nuttallwin (temporal resolution is misleading!)','fontunit','normalized','fontsize',0.035);
        end;
